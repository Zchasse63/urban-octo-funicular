      ...
      <div className="prose prose-lg max-w-none space-y-8">
        ...
        <div className="mt-12">
          <AlertCard
            variant="info"
            title="Note"
            description="This is placeholder legal content. Before launch, these Terms of Service must be reviewed by qualified legal counsel to ensure compliance with applicable laws and proper protection of both user and company interests."
          />
        </div>
      </div>
    </div>
